...
// delete from dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates;

//Change XOB00824 with consumer account name and adjust query template as per requirement

insert into dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates (party_account,template_name, template, dimensions, template_type)
values ('XOB00824','customer_overlap',
$$
select
    {% if dimensions %}
...
insert into dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates (party_account,template_name, template, dimensions, template_type)
values ('XOB00824','customer_overlap_multiparty',
$$
select
    identifier({{ dimensions[0] }})
    {% for dim in dimensions[1:] %}
...
insert into dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates (party_account,template_name, template, dimensions, template_type)
values ('XOB00824','customer_overlap_waterfall',
$$
select
    identifier({{ dimensions[0] }})
    {% for dim in dimensions[1:] %}
...
insert into dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates (party_account,template_name, template, dimensions, template_type)
values ('XOB00824','campaign_conversion',
$$
...
insert into dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates (party_account,template_name, template, dimensions, template_type)
values ('XOB00824','customer_overlap_multiparty_subscribers',
$$
select
    identifier({{ dimensions[0] }})
    {% for dim in dimensions[1:] %}
...
// see templates
// select * from dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates;
...
select dcr_DCR_CLEANROOMPOC_provider_db.templates.get_sql_jinja(
  (select template from dcr_DCR_CLEANROOMPOC_provider_db.templates.dcr_templates where template_name = 'campaign_conversion'),
   object_construct(
            ...
            'app_data','dcr_DCR_CLEANROOMPOC_provider_db',
