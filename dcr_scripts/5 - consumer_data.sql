...
create or replace schema dcr_DCR_CLEANROOMPOC_consumer.mydata;
...
create or replace table dcr_DCR_CLEANROOMPOC_consumer.mydata.customers 
...
create or replace table dcr_DCR_CLEANROOMPOC_consumer.mydata.conversions 
comment='{"origin":"sf_ps_wls","name":"dcr","version":{"major":5, "minor":5},"attributes":{"component":"dcr",“role”:“consumer”}}'
as
...
from dcr_DCR_CLEANROOMPOC_consumer.mydata.customers sample (10)
;

//select * from dcr_DCR_CLEANROOMPOC_consumer.mydata.customers;
//select * from dcr_DCR_CLEANROOMPOC_consumer.mydata.conversions;


///////
// XOB00824 USER SETTINGS
///////

//create local settings table - provider1
create or replace schema dcr_DCR_CLEANROOMPOC_consumer.local;
create or replace table dcr_DCR_CLEANROOMPOC_consumer.local.user_settings (setting_name varchar(1000), setting_value varchar(1000))
comment='{"origin":"sf_ps_wls","name":"dcr","version":{"major":5, "minor":5},"attributes":{"component":"dcr",“role”:“consumer”}}';

//populate the local settings table - provider1
delete from dcr_DCR_CLEANROOMPOC_consumer.local.user_settings;
insert into dcr_DCR_CLEANROOMPOC_consumer.local.user_settings (setting_name, setting_value)
 VALUES ('app_data','dcr_DCR_CLEANROOMPOC_app'),
        ('app_two_data','dcr_DCR_CLEANROOMPOC_app_two'),
        ('app_three_data','dcr_DCR_CLEANROOMPOC_app_three'),
        ('consumer_db','dcr_DCR_CLEANROOMPOC_consumer'),
        ('consumer_schema','mydata'),
        ('consumer_table','customers'),
        ('consumer_join_field','email'),
        ('app_instance','dcr_DCR_CLEANROOMPOC_app'),
        ('app_two_instance','dcr_DCR_CLEANROOMPOC_app_two'),
        ('app_three_instance','dcr_DCR_CLEANROOMPOC_app_three'),
        ...
        ('consumer_requests_table','dcr_DCR_CLEANROOMPOC_consumer.MFB86782_schema.requests'),
